	...
	[5093], {
		...
		37504: e => {
			e.exports = {
				...
				"maximize-animation-up-bracket": "maximize-animation-up-bracket-2RChU0rC",
				"maximize-animation-down-bracket": "maximize-animation-down-bracket-2RChU0rC",
				"minimize-animation-up-bracket": "minimize-animation-up-bracket-2RChU0rC",
				"minimize-animation-down-bracket": "minimize-animation-down-bracket-2RChU0rC",
				up: "up-2RChU0rC",
			...
			class $ {
				...
				_initGroupDescriptions() {
					return [{
						...
						shouldBeHiddenOnMobile: !o.enabled("show_zoom_and_move_buttons_on_touch"),
				...
				_updateBtnGroupVisibility() {
					...
					for (const e of this._visibilityPrioritizedGroups) {
						...
						e.available() && (!Y || !e.shouldBeHiddenOnMobile) && (s -= e.totalWidth, e.enoughSpaceForGroup = s >= 0 && !i, i = i || !e.enoughSpaceForGroup), !e.enoughSpaceForGroup !== e.element.classList.contains("js-hidden") && e.element.classList.toggle("js-hidden", !e.enoughSpaceForGroup)
					}
		...
		56786: (e, t, s) => {
			...
			function w(e, t) {
				if (e.getAttribute('data-name') !== 'legend-source-title') {
					if (t) {
						t = t.replace(/[\u{0080}-\u{10FFFF}]/gu, "");
						t = "\u202A" + t;
					} else t = "\u202A\u0009";
				}

				e.firstChild === null ? e.textContent = t : e.firstChild.nodeValue = t;
			}
			var y = s(92271);
			...
			class M {
				constructor(e, t, s) {
					...
					this._loading.subscribe(function (e, t) {
						let s = 0;
						return i => {
							clearTimeout(s);
					...
					if (this._withActions) {
						this._showActionsHandler = (0, p.wrapHandlerWithPreventEvent)(this._showActions.bind(this));
						this._hideActionsHandler = (0, p.wrapHandlerWithPreventEvent)(this._hideActions.bind(this));
						this._selectedSourceHandler = (0, p.wrapHandlerWithPreventEvent)(this._model.setSourceSelected.bind(this._model));
						...
						if (null !== this._titleParentEl) {
							...
							this._mouseEventHandlers.push(new _.MouseEventHandler(this._titleParentEl, {
						...
						if (null === this._actionAdditionalWrapperEl || null === this._actionsParentEl || S) {
				...
				destroy() {
					...
					if (null !== this._titleParentEl) {
						...
						if (this._withActions && null !== this._selectedSourceHandler && null !== this._showActionsHandler && null !== this._hideActionsHandler) {
				...
				updateMode(e) {
					if (!(this._mode === e && null !== this._allButtonsWidth)) return;
				...
				_render() {
					...
					/* Symbol Full Name */
					if (null !== this._actionsParentEl) this._firstBlockWrapper.appendChild(this._actionsParentEl);
				...
				_renderActions() {
					...
					for (const s of this._model.actions()) {
						const i = (0, c.createActionElement)(s, y.button, y.buttonIcon, m.blockHidden, t);
						e.appendChild(i);
					}
				}
				_isWidthButtonsMode() {
				...
				_updateValueVisibleHandler(e, t) {
					const s = (0, i.ensure)(this._valuesElements[e].value).closest("." + y.valueItem);
				...
				_updateShowValues() {
					if (null === this._valuesAdditionalWrapperEl) return;
				...
				_hideActions() {
					if (!(null !== this._el && this._withActions && !this._stayInHoveredMode)) return;
				...
				_handlerRestrictTitleWidth(e) {
					...
					if (t === this._lastStatusesWrapperWidth && s === this._lastActionsWrapperWidth) {
				...
				_updateShowTitles() {
					if (null === this._titleParentEl) return;
					this._titleParentEl.classList.toggle(m.blockHidden, this._isTitleHidden.value());
					null !== this._actionsParentEl && this._actionsParentEl.classList.toggle(m.blockHidden, this._isTitleHidden.value());
				}
				_updateValues() {
					this._removeValuesSpawnsSubscriptions();
					this._createValuesSpawns();

					if (null !== this._valuesParentEl && null !== this._valuesAdditionalWrapperEl) {
						this._valuesElements = [];
				...
				_updateCustomTextColor() {
					...
					const t = (0, i.ensureNotNull)(this._valuesParentEl).querySelectorAll("." + y.valueTitle);
					for (let s = 0; s < t.length; s++) t[s].style.color = e;
					(0, i.ensureNotNull)(this._el).classList.toggle(y.withCustomTextColor, Boolean(e))
				}
			...
			class f extends M {
				...
				_updateFlaggedState() {
					...
					(0, i.ensureNotNull)(this._el).classList.toggle(y.flagged, Boolean(this._flagged.value())), this._updateTitleMaxWidth()
				}
			}
			...
			class N {
				...
				_render() {
					this._el = document.createElement("div"), this._el.className = y.toggler + " apply-common-tooltip", this._arrowIconEL = document.createElement("div"), this._arrowIconEL.classList.add(y.iconArrow), this._arrowIconEL.innerHTML = h.trackingModeIsAvailable ? x : T, this._el.appendChild(this._arrowIconEL), this._objectTreeEl = document.createElement("div"), this._objectTreeEl.classList.add(y.objectTree), this._objectTreeEl.innerHTML = h.trackingModeIsAvailable ? L : D,
						this._el.appendChild(this._objectTreeEl), this._counterEl = document.createElement("div"), this._counterEl.classList.add(y.counter), this._counterEl.appendChild(document.createTextNode(String(this._sourceCount.value()))), this._el.appendChild(this._counterEl), this._parentEl.appendChild(this._el)
				}
				_updateThemedColor(e) {
					if (null !== this._el)
						if (e.length > 0) {
							const [t, s, i] = (0, r.parseRgb)(e);
							this._el.style.backgroundColor = (0, r.rgbaToString)([t, s, i, (0, r.normalizeAlphaComponent)(.8)])
				...
				_updateState() {
					...
					this._parentEl.classList.toggle(y.closed, e), this._updateTooltip(), W((e ? "Hide" : "Show") + " not main sources")
				}
				_tooltip() {
				...
				_updateObjectTreeVisibility(e) {
					(0, i.ensureNotNull)(this._el).classList.toggle(y.objectsTreeCanBeShown, e)
				}
			}
			var P = s(74384),
				I = s(59726);
			...
			class R {
				...
				addMainDataSource(e, t) {
					this._renderMainDataSourceEl(), this._mainDataSourceRenderer = new f(e, (0, i.ensureNotNull)(this._mainDataSourceEl), {
				...
				addDataSources(e, t) {
					...
					for (let i = 0; i < e.length; i++) {
						...
						this._dataSourceRenderers.push(a), this._updateLegendVisibility(), l.onDestroy().subscribe(this, () => {
							const e = this._dataSourceRenderers.indexOf(a); - 1 !== e && (this._dataSourceRenderers[e].destroy(), this._dataSourceRenderers.splice(e, 1))
						}, !0)
					}
				}
				addCustomWidget(e, t) {
				...
				_renderToggle(e) {
					this._options.showToggleButton && (this._renderToggler = new N(e, this._options.themedColor, this._togglerOptions))
				}
				...
				_addOutsideEventForHideTooltip() {
					null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), this._outsideEventForCollapsedTooltip = (0, I.addOutsideEventListener)(new CustomEvent("timestamp").timeStamp, this._collapsedDataSourcesWrapperEl, () => {
						null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), (0, P.hide)()
					}, window.document, {
						touchEnd: !0
					})
				}
				_updateCollapsedSourcesCount(e) {
					...
					const t = 0 === e;
					this._collapsedDataSourcesWrapperEl.classList.toggle(m.blockHidden, t), t || (w(this._collapsedDataSourcesEl, "+" + e), this._collapsedDataSourcesEl.setAttribute("title", this._options.collapsedDataSourcesTitle.value()))
				}
				...
				_setCustomBg() {
					...
					if (e) {
						...
						i = (0, r.rgbaToString)([e, l, a, (0, r.normalizeAlphaComponent)(1 - s / 100)])
					}
			...
			const J = new G.TranslatedString("show {title}", (0, k.t)("show {title}")),
				Q = new G.TranslatedString("hide {title}", (0, k.t)("hide {title}")),
				ee = (0, k.t)("Show"),
				te = (0, k.t)("Hide");
			class se {
				constructor(e, t, s, i, l) {
					this._values = new (a())([]), this._actions = [], this._onDestroy = new (X()), this._loading = new (a())(!1), this._moreActionCM = null, this._updateLoadingStatus = () => {
						this._loading.setValue(this._source.isLoading())
					}, this._model = e, this._source = t, this._options = s, this._callbacks = i, this._contextMenuOptions = l, this._disabled = new (a())(this._getDisabledState()), this._disabledOnInterval = new (a())(this._getDisabledOnIntervalState()), this._selected = new (a())(!1), this._isTitleHidden = new (a())(this._getTitleHiddenValue()), this._isValuesHidden = new (a())(this._getValuesHiddenValue()), this._isRowHidden = new (a())(this._getRowHiddenValue()), (0, q.combine)(() => ({}), this._isTitleHidden, this._isValuesHidden, this._disabled).subscribe(this._updateRowVisibilities.bind(this)), this._values.subscribe(() => {
				...
				onToggleDisabled() {
					const e = this._source.properties().childs().visible,
						t = !e.value();
					this._model.setProperty(e, t, (t ? J : Q).format({
						title: new G.TranslatedString(this._source.name(), this._source.title())
					})), W((t ? "Show" : "Hide") + " source")
				}
				onShowSettings(e) {
					this._source.userEditEnabled() && (this.setSourceSelected(), this._callbacks.showChartPropertiesForSource(this._source, e), W("Settings for source"))
				}
				onShowMoreActions(e) {
					return this._options.readOnlyMode ? Promise.resolve(null) : (this._callbacks.updateActions(), W("Show source context menu"), this._callbacks.showContextMenuForSources([this._source], this._calcNewPosition(e), this._contextMenuOptions))
				}
				setSourceSelected() {
			...
			class _e extends se {
				constructor(e, t, s, i, l) {
					super(e, t, s, i, l), this._titles = {
						...
						chartStyle: new (a())(""),
						branding: new (a())("")
					}, this._symbolMarker = null, this._symbolMarkerIcon = null, this._flagged = new (a())(null), this._symbolAction = null, this._symbol = null, this._isOneButtonCanBeStick = !1, this._createActions(), this._updateSymbolMarker();
					...
					}), this._valuesVisibleProperty = (0, j.combineProperty)((e, t, s) => e || t || s, o.showSeriesOHLC, o.showBarChange, o.showVolume), this._valuesVisibleProperty.subscribe(null, () => {
						this._isValuesHidden.setValue(this._getValuesHiddenValue())
					}), this.update(), this._source.onStatusChanged().subscribe(this, this._updateLoadingStatus)
				}
				destroy() {
					super.destroy(), this._model.model().properties().childs().paneProperties.childs().legendProperties.childs().showSeriesTitle.unsubscribeAll(this), this._source.onStatusChanged().unsubscribeAll(this), this._valuesVisibleProperty.destroy(), this._onDestroy.fire()
				}
				flagged() {
				...
				_updateTitles() {
					...
					this._titles.title.setValue((0,
						U.clean)(t.title, !0)), this._titles.description.setValue((0, U.clean)(t.description, !0)), ce || this._titles.interval.setValue((0, U.clean)(t.interval, !0)), this._titles.provider.setValue((0, U.clean)(t.provider, !0)), this._titles.exchange.setValue((0, U.clean)(t.exchange, !0)), this._titles.chartStyle.setValue((0, U.clean)(t.chartStyle, !0)), this._titles.branding.setValue((0, U.clean)(null !== (e = t.branding) && void 0 !== e ? e : "", !0))
				}
				_updateValues() {
					...
					if (0 === t.length) {
						...
						for (let e = 0; e < l.length; e++) {
							const s = l[e];
							t[e + 1].value.setValue(s.value()), t[e + 1].color.setValue(K(s.color())), t[e + 1].visible.setValue(s.visible()), t[e + 1].title.setValue(s.title())
						}
					}
				}
				_updateStates() {
				...
				_createActions() {
					if (ue) {
						const e = {
							...
							action: (0, p.wrapHandlerWithPreventEvent)(this.onToggleDisabled.bind(this)),
							visible: new (a())(!0),
							className: y.eye,
				...
				_symbolActionHandler() {
					null !== this._symbolMarker && (this._updateSymbolMarker(), W("Change flag state"))
				}
				_updateSymbolMarker() {
			...
			const Ce = (0, k.t)("Settings"),
				...
				ke = (0, k.t)("Remove"),
				Ve = (0, k.t)("More"),
				We = ((0, k.t)("Error"), (0, k.t)("Could not get Pine source code."), (0, k.t)("Show interval settings")),
			...
			class Ae extends se {
				constructor(e, t, s, i, l) {
					super(e, t, s, i, l), this._titles = {
						title: new (a())(""),
						args: new (a())("")
					}, this._error = new (a())(!1), this._isPineScriptDataSource = new (a())(!1), this._pineAction = null, this._globalVisibility = new (a())(!0), this._createActions();
					const o = this._model.model().properties().childs().paneProperties.childs().legendProperties.childs(),
				...
				onRemoveSource() {
					var e;
					this._source.isUserDeletable() && (this._source.hasChildren() ? (e = this._model.removeSource.bind(this._model, this._source, !1), (0, me.showConfirm)({
					...
					})) : this._model.removeSource(this._source, !1), W("Remove sources"))
				}
				onShowSourceCode() {
					0
				}
				...
				_updateValues() {
					...
					if (0 === t.length) {
						...
						for (let e = 0; e < s.length; e++) {
							const i = t[e],
								l = s[e];
							i.value.setValue(l.value()), i.color.setValue(K(l.color())), i.visible.setValue(l.visible())
						}
					}
				}
				_updateStates() {
				...
				_getDisabledOnIntervalState() {
					return !(!(0, pe.isStudy)(this._source) && !(0, pe.isStudyStub)(this._source)) && !this._source.isActualInterval()
				}
				_getValuesHiddenValue() {
				...
				_createActions() {
					if (!this._options.readOnlyMode) {
						if (this._pineAction = {
							...
							action: (0, p.wrapHandlerWithPreventEvent)(this.onShowSourceCode.bind(this)),
							visible: new (a())(!1),
							title: new (a())(Ee),
							dataset: {
							...
							const t = {
								...
								action: (0, p.wrapHandlerWithPreventEvent)(this.onShowSettings.bind(this, ie.TabNames.visibility)),
								visible: new (a())(this._getDisabledOnIntervalState()),
						...
						xe && De && (!(0, pe.isStudy)(this._source) || new ge.MetaInfoHelper(this._source.metaInfo()).hasUserEditableOptions()) && this._actions.push({
							iconMap: new Map([
								["large", ve],
								["small", ve]
							]),
							action: (0, p.wrapHandlerWithPreventEvent)(this.onShowSettings.bind(this)),
							visible: new (a())(!0),
							title: new (a())(Ce),
							dataset: {
								name: "legend-settings-action"
							}
						}), Le && this._actions.push({
							iconMap: new Map([
								["large", Se],
								["small", ye]
							]),
							action: (0, p.wrapHandlerWithPreventEvent)(this.onRemoveSource.bind(this)),
							visible: new (a())(!0),
							title: new (a())(ke),
							dataset: {
			...
			const Oe = new G.TranslatedString("change symbol description visibility", (0, k.t)("change symbol description visibility")),
				Fe = new G.TranslatedString("change open market status visibility", (0, k.t)("change open market status visibility")),
				Re = new G.TranslatedString("change OHLC values visibility", (0, k.t)("change OHLC values visibility")),
				Ue = new G.TranslatedString("change bar change visibility", (0, k.t)("change bar change visibility")),
				je = new G.TranslatedString("change indicator titles visibility", (0, k.t)("change indicator titles visibility")),
				Ye = new G.TranslatedString("change indicator arguments visibility", (0, k.t)("change indicator arguments visibility")),
				Ge = new G.TranslatedString("change indicator values visibility", (0, k.t)("change indicator values visibility")),
				$e = new G.TranslatedString("change volume values visibility", (0, k.t)("change volume values visibility")),
				Xe = (0, k.t)("Symbol"),
				Ze = (0,
					k.t)("Open market status"),
			...
			function ct(e, t) {
				const s = ht(t);
				return 0 === e[s].entries.length ? ct(e, s) : {
					dayIndex: s,
					entries: e[s].entries
				}
			}
			...
			function _t(e, t) {
				const s = ut(t);
				return 0 === e[s].entries.length ? _t(e, s) : {
					dayIndex: s,
					entries: e[s].entries
				}
			}
			...
			function vt(e) {
				const t = e.start(),
					...
					a = pt(t),
					o = pt(t + s);
				return s > rt.minutesPerDay ? `${ot.weekDaysShortNames[i]} ${a} — ${ot.weekDaysShortNames[l]} ${o}` : `${a} — ${o}`
			}

			function wt(e, t, s, i) {
				return Math.abs(i - s) > 1 ? `${ot.weekDaysShortNames[s]} ${e.title} — ${ot.weekDaysShortNames[i]} ${t.title}` : `${e.title} — ${t.title}`
			}
				...
				for (const i of t) {
					...
					for (let l = 0; l < n.length; l++) {
						const a = n[l],
							...
							h = (0, it.lowerbound)(e[t].entries, d, (e, t) => e.start.value < t),
							u = {
								start: {
									value: d,
									title: pt(o),
			...
			class St {
				constructor(e) {
					this.sessionsDays = new (a())((0, o.clone)(mt)), this.todaySession = new (a())((0, o.clone)({
						entries: []
				...
				currentTimeValue() {
					return null === this._todayInExchangeTime ? -1 : rt.get_minutes_from_midnight(this._todayInExchangeTime) / rt.minutesPerDay
				}
				timezone() {
				...
				_updateEntriesBySubSessions(e) {
					...
					const s = this._createSubSessionSpecs(e),
						l = (a = (null === (t = this._todayInExchangeTime) || void 0 === t ? void 0 : t.getUTCDay()) || (new Date).getDay()) < nt.WeekDays.SATURDAY ? a + 1 : nt.WeekDays.SUNDAY;
					var a;
					const n = (0, o.clone)(mt);
					n[l].isActive = !0;
					for (const e of Array.from(s.keys())) {
						yt(n, (0, i.ensureDefined)(s.get(e)).getEntriesForWeekByCalendar((0, i.ensureNotNull)(this._todayInExchangeTime)), e)
					} ! function (e) {
						const t = pt(0),
						...
						for (const a of Object.keys(e)) {
							...
							for (let e = 0; e < p; e++) {
								const s = n[e],
									l = e > 0 ? n[e - 1] : null,
									a = 0 === e;
								if (0 === s.start.value || 0 === s.start.value && 1 === s.end.value || null !== l && s.start.value === l.end.value) {
									m++;
									continue
								}
								const r = a ? c.entries[c.entries.length - 1] : (0, i.ensureNotNull)(l),
									d = {
										start: {
											value: a ? 0 : n[e - 1].end.value,
											title: a ? t : n[e - 1].end.title,
											isFirstOrLastPoint: !(a && h.length > 0) || 1 === h[h.length - 1].end.value
										},
										end: {
											value: s.start.value,
											title: s.start.title,
						...
						function (e) {
							for (const i of Object.keys(e)) {
								...
								const o = ht(l),
									...
									r = a[0],
									d = a[a.length - 1];
								r.start.isFirstOrLastPoint || (r.showStartForLastEntry = (t = a, s = e[o].entries, gt(t[t.length - 1], s[s.length - 1]))), d.end.isFirstOrLastPoint || (d.showEndForFirstEntry = bt(a, e[n].entries))
							}
							var t, s
						}(n), this.sessionsDays.setValue(n), this.todaySession.setValue(n[l])
				}
				_createSubSessionSpecs(e) {
					if (null === e) return new Map;
					if (void 0 === e.subsessions) return new Map([
						[0, new dt.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)]
					]);
					...
					for (const i of t) {
						...
						if (null !== t) {
							...
							void 0 !== l && s.set(t, new dt.SessionSpec(e.timezone, l["session-display"] || l.session, e.session_holidays, l["session-correction"]))
						}
					}
					return s
				}
				_updateTodayWithOffsets(e) {
					...
					this._todayInExchangeTime = rt.get_cal_from_unix_timestamp_ms(rt.get_timezone(e.timezone), Date.now() + t)
				}
			}
			var Mt = s(67294),
				ft = s(94184),
			...
			function Wt(e) {
				return Vt.has(e) || Vt.set(e, (0, Et.randomHash)()), (0, i.ensureDefined)(Vt.get(e))
			}
			const Tt = new Map([
				[0, kt.green],
				[1, kt.orange],
			...
			function Lt(e) {
				const {
					...
					forceStart: s,
					forceEnd: i
				} = e, l = t.end.value - t.start.value, a = l < .03, o = {
					left: 100 * t.start.value + "%",
					width: `calc(${100 * l}% + ${a ? 2 : 0}px)`
				}, n = ft(kt.segment, Tt.get(t.type), (s || t.start.isFirstOrLastPoint) && kt.start, (i || t.end.isFirstOrLastPoint) && kt.end, a && kt.small, "common-tooltip-html", "apply-common-tooltip"), r = function (e, t) {
			...
			function At(e) {
				const {
					sessionDay: t
				} = e, s = t.entries.map((e, s) => Mt.createElement(Lt, {
					key: Wt(e) + "Segment",
					segment: e,
				...
				return Mt.createElement("div", {
					...
					className: kt.weekDay
				}, t.title), Mt.createElement("div", {
					className: kt.sessionDaySegments
				}, s))
			}
			...
			function Ht(e) {
				const {
					sessionDays: t,
					currentTimeMark: s
				} = e, i = [], l = parseInt(Object.keys(t).filter(e => t[parseInt(e)].isActive)[0]), a = t[l], o = a.entries.filter(e => e.start.value <= s && e.end.value >= s)[0];
				!o.start.isFirstOrLastPoint && o.showStartForLastEntry ? i.push(a.entries[a.entries.length - 1].start) : i.push(o.start);
				const n = !o.end.isFirstOrLastPoint && o.showEndForFirstEntry ? a.entries[0].end : o.end;
				if (i[0].value !== n.value && i.push(n), 0 === i.length) return null;
				i.sort((e, t) => e.value - t.value);
				const r = i.map(e => Mt.createElement("div", {
					key: Wt(e),
					className: kt.timeMark
				}, e.title)),
				...
				renderer(e, t) {
					return function (e) {
						const {
							...
							now: i,
							timezone: l
						} = e, a = (0, Ct.useWatchedValueReadonly)({
							watchedValue: e.sessionDays
						}), o = Object.values(a).filter(e => e.isActive)[0], n = ft(s, kt.wrapper);
						return Mt.createElement("div", {
							key: t,
							className: n
						}, Mt.createElement("div", {
			...
			class zt {
				constructor(e) {
					this.isBlinkingMode = new (a())(!1), this._status = new (a())(null), this._fullTooltip = new (a())(null), this._iconClassNames = new (a())(null), this._visible = new (a())(!1), this._tooltip = new (a())(null), this._icon = new (a())(null), this._className = new (a())(null), this._infoMaps = e, this._size = e.size || "small", this._status.subscribe(this._updateByStatus.bind(this), {
						callWithLast: !0
				...
				async _getHtml(e) {
					var t, s, i;
					return null !== (i = null === (s = null === (t = this._infoMaps.htmlMap) || void 0 === t ? void 0 : t.get(e)) || void 0 === s ? void 0 : s.map(Pt.htmlEscape)) && void 0 !== i ? i : null
				}
				_getAction(e) {
					var t, s;
				...
				_updateIconClassName(e) {
					null !== e ? this._iconClassNames.setValue([It.statusItem, e]) : this._iconClassNames.setValue(null)
				}
			}
			var Ot = s(64222);
			const Ft = [];
			...
			function jt(e) {
				...
				t.includes(e) || (t.push(e), Ot.setJSON("tv.alreadyBlinkedStatuses", t), Ut.setValue(Rt()))
			}
			...
			var Gt = s(97849),
				...
				Jt = s(5749);
			const Qt = (0,
				be.getLogger)("Chart.LegendWidget"),
				es = ["TFEXDelayForGuest", "MOEXDelayForGuest", "CHIXAuDelayForGuest", "LSEDelayForGuest", "NGMDelayForGuest", "DEForGuest", "ICESGDelayForGuest"],
				ts = new Map([
				...
				ds = (0, Pt.htmlEscape)((0, k.t)("{symbolName} data is delayed by {time} minutes.")),
				hs = (0, Pt.htmlEscape)((0, k.t)("{listedExchange} real-time data is available for free to registered users.")),
				us = (0, Pt.htmlEscape)((0, k.t)("To get real-time data for {description}, please buy the real-time data package.")),
				cs = (0, Pt.htmlEscape)((0, k.t)("Real-time data for {description} is not supported right now. We may support it in the future.")),
				_s = (0, Pt.htmlEscape)((0, k.t)("Data is updated once a day.")),
				ps = (0, Pt.htmlEscape)((0, k.t)("Data on our Basic plan is updated once per second, even if there are more updates on the market.")),
				ms = (0, Pt.htmlEscape)((0, k.t)("Data is updated once per second, even if there are more updates on the market.")),
				gs = (0, Pt.htmlEscape)((0,
					k.t)("Paid plans feature faster data updates.")),
				bs = (0, Pt.htmlEscape)((0, k.t)("Real-time data for {symbolName} is provided by {exchange} exchange.")),
				vs = (0, Pt.htmlEscape)((0, k.t)("This data is real-time, but it’s slightly different to its official counterpart coming from primary exchanges.")),
				ws = (0, Pt.htmlEscape)((0, k.t)("This data is real-time, but it’s slightly different to its official counterpart coming from {exchange}.")),
				ys = (0, Pt.htmlEscape)((0, k.t)("If you'd like {listedExchange} real-time data you'll need to complete an Exchange Agreement. Don't worry, it only takes a few clicks"));
			(0, k.t)("Create a free account"), (0, k.t)("Learn more"), (0, Pt.htmlEscape)((0, k.t)("Fill out Exchange Agreements"));
			class Ss extends zt {
				constructor(e, t, s) {
					super({
						iconMap: ts,
						...
						titleColorMap: is,
						size: t
					}), this._dataUpdatedMode = new (a())(null).spawn(), this._options = s, this._model = e, this._dataModeBlinkingStatuses = Yt.spawn(), this._dataModeBlinkingStatuses.subscribe(this._updateBlinkingMode.bind(this)), this.turnOffBlinkingMode = this._turnOffBlinking.bind(this), this.setModel(e)
				}
				destroy() {
					this._dataUpdatedMode.destroy(), this._dataModeBlinkingStatuses.destroy()
				}
				setModel(e) {
					if (this._dataUpdatedMode.destroy(), null === e) return this._model = e, void (this._dataUpdatedMode = new (a())(null).spawn());
				...
				async _getHtmls() {
					...
					try {
						...
						Qt.logError("Can't get exchange description, reason: " + (0, Gt.errorToString)(e))
					}
					for (const a of e)
						if (t[a] = [], ["DelayToRealtime", "DelayNoRealtime", "DelayWithoutMarketAgreement", ...es].includes(a) && (t[a].push(ds.format({
							symbolName: s,
							time: this._model.time().toString()
						})), this._options.subscriptionFullInfo && null !== i && "DelayToRealtime" === a && t[a].push(us.format({
							description: `<b>${i}</b>`
						})), null !== i && "DelayNoRealtime" === a && t[a].push(cs.format({
							description: `<b>${i}</b>`
						})), "DelayWithoutMarketAgreement" === a && t[a].push(ys.format({
							listedExchange: this._model.listedExchange()
						})), this._options.subscriptionFullInfo && es.includes(a) && t[a].push(hs.format({
							listedExchange: this._model.listedExchange()
						}))), "EOD" === a && (t[a] = [_s]),
							"TickByTick" === a && (t[a].push(this._options.subscriptionFullInfo ? ps : ms), this._options.subscriptionFullInfo && t[a].push(gs)), null !== l && "BATSToRealtime" === a) {
							let e = this._model.listedExchange();
							0, t[a].push(bs.format({
								symbolName: s,
								exchange: l
							}), "" !== e ? ws.format({
								exchange: e
				...
				_getShortTexts() {
					...
					const s = {};
					for (const i of t)
						if (["DelayToRealtime", "DelayNoRealtime", ...es, "DelayWithoutMarketAgreement"].includes(i) && (s[i] = ls), "EOD" === i && (s[i] = as), "TickByTick" === i && (s[i] = os), "BATSToRealtime" === i) {
			...
			class xs extends zt {
				constructor(e, t, s) {
					super({
						...
						titleColorMap: Ts,
						size: t
					}), this._dataSourceErrorStatus = new (a())(null).spawn(), this._lastError = null, this._options = s, this.setSource(e)
				}
				destroy() {
			...
			class Ns extends zt {
				constructor(e, t) {
					super({
						...
						titleColorMap: Bs,
						size: t
					}), this._dataProblem = new (a())(null).spawn(), this._isDataProblemCritical = new (a())(!1), this.setModel(e)
				}
				destroy() {
			...
			class Ps extends zt {
				constructor(e, t) {
					super(t), this._booleanStatus = new (a())(!1).spawn(), this.updateStatus(e)
				}
				destroy() {
			...
			class Zs {
				...
				_render(e) {
					this._el.classList.add(It.statusItem, It[this._size]), e.appendChild(this._el)
				}
				_updateVisibility(e) {
			...
			class qs {
				...
				_updateSpecialClassAndTooltip() {
					...
					this.element.classList.toggle(It.oneWidgetsVisible, 1 === e), this.element.classList.toggle(It.twoWidgetsVisible, 2 === e), this.element.classList.toggle(It.threeWidgetsVisible, 3 === e), this._updateTooltip()
				}
				_updateBlinkingMode() {
			...
			const ai = (0, k.t)("Market open"),
				...
				Si = (0,
					k.t)("It'll open for pre-market trading in {remainingTime}."),
				Mi = new Map([
					["market", new Map([
						["small", Js],
						["large", Qs]
			...
			function xi(e) {
				...
				return 0 === t && 0 === s && 0 === i ? mi : t > 0 ? gi.format({
					days: (l = t, (0, k.t)("{number} day", {
						plural: "{number} days",
						count: l
					}).format({
						number: l.toString()
			...
			const Di = {
				market: e => ("post_market" === e.status ? yi : wi).format({
					remainingTime: xi(e.remainingSeconds)
				}),
				pre_market: e => vi.format({
					remainingTime: xi(e.remainingSeconds)
				}),
				post_market: e => wi.format({
					remainingTime: xi(e.remainingSeconds)
				}),
				out_of_session: e => ("pre_market" === e.status ? Si : vi).format({
					remainingTime: xi(e.remainingSeconds)
				}),
				holiday: e => ("pre_market" === e.status ? Si : vi).format({
					remainingTime: xi(e.remainingSeconds)
				})
			},
				Li = new Map([
			...
			class Ai extends zt {
				constructor(e, t) {
					super({
						...
						actionMap: Li,
						size: t
					}), this._model = null, this._marketStatus = new (a())(null).spawn(), this._sessionEdge = new (a())(null).spawn(), this._updateTooltip = () => {
						const e = this._status.value();
						null !== e && this._updateFullTooltipByStatus(e)
					}, this.setModel(e)
				}
				destroy() {
					this._marketStatus.destroy(), this._sessionEdge.destroy(), this._model = null
				}
				setModel(e) {
					if (this._marketStatus.destroy(), this._sessionEdge.destroy(), null === e) return this._marketStatus = new (a())(null).spawn(), void (this._sessionEdge = new (a())(null).spawn());
					this._model = e, this._marketStatus = e.status().spawn(), this._marketStatus.subscribe(this._updateStatus.bind(this), {
						callWithLast: !0
					}), this._sessionEdge = e.nextSessionEdge().spawn(), this._sessionEdge.subscribe(this._updateTooltip), this._updateTooltip()
				}
				async _getHtml(e) {
					const t = [(0,
						Pt.htmlEscape)(Vi[e])],
			...
			class Hi {
				constructor(e, t) {
					var s, i;
					this.visibleWidgetsCount = new (a())(0), this.errorWidgetIsShown = new (a())(!1), this._size = h.trackingModeIsAvailable ? "large" : "small", this._tooltips = new (a())([]), this._visibilitySpawns = [], this._tooltipSpawns = [], this._statusWidgetInfos = [], this._renderer = new qs(this._size, this.visibleWidgetsCount, this._tooltips, {
						onClick: this._handleToggleDropdown.bind(this)
					}), this._symbolInvalidViewModel = null, this._dataSourceErrorStatusViewModel = null, this._marketStatusViewModel = null, this._dataUpdatedModeViewModel = null, this._dataProblemViewModel = null, this._sessionWidget = null, this._dataSourceHasErrorVisible = null, this._dataSourceErrorCanBeShown = new (a())(!1), this._marketStatusCanBeShown = new (a())(!1), this._dataUpdatedModeCanBeShown = new (a())(!1), this._dataProblemCanBeShown = new (a())(!1), this._isDataProblemCritical = null, this._container = document.createElement("div"), this._menuOpened = !1, this._menuPosition = null, this._handleDropdownMenuClose = () => {
						var e;
				...
				_recreateWidgets() {
					...
					if (this._options.sourceStatusesEnabled) {
						...
						if (null === this._dataSourceErrorStatusViewModel) {
							this._dataSourceErrorStatusViewModel = new xs(this._source, this._size, this._options.sourceStatuses), this._dataSourceHasErrorVisible = (0, q.combine)(() => this._dataSourceErrorCanBeShown.value() && (0, i.ensureNotNull)(this._dataSourceErrorStatusViewModel).visible().value(), this._dataSourceErrorCanBeShown, this._dataSourceErrorStatusViewModel.visible()), this._visibilitySpawns.push(this._dataSourceHasErrorVisible), this._tooltipSpawns.push(this._dataSourceErrorStatusViewModel.tooltip().spawn());
							const e = {
					...
					if (this._options.marketStatusEnabled) {
						...
						if (null === this._marketStatusViewModel) {
							...
							const e = (0, q.combine)(() => this._marketStatusCanBeShown.value() && (0, i.ensureNotNull)(this._marketStatusViewModel).visible().value(), this._marketStatusCanBeShown, this._marketStatusViewModel.visible());
							...
							null !== t && (this._sessionWidget = new Bt(this._source), s.additionalWidgets = [this._sessionWidget]), this._statusWidgetInfos.push(s), this._renderer.addStatusModel(s)
					...
					if (this._options.dataUpdateModeEnabled) {
						...
						if (null === this._dataUpdatedModeViewModel) {
							this._dataUpdatedModeViewModel = new Ss(e, this._size, this._options.dataUpdateMode);
							const t = (0, q.combine)(() => this._dataUpdatedModeCanBeShown.value() && (0, i.ensureNotNull)(this._dataUpdatedModeViewModel).visible().value(), this._dataUpdatedModeCanBeShown, this._dataUpdatedModeViewModel.visible());
					...
					if (this._options.dataProblemEnabled) {
						...
						if (null === this._dataProblemViewModel) {
							this._dataProblemViewModel = new Ns(e, this._size), this._isDataProblemCritical = this._dataProblemViewModel.isDataProblemCritical().spawn();
							const t = (0, q.combine)(() => this._dataProblemCanBeShown.value() && (0, i.ensureNotNull)(this._dataProblemViewModel).visible().value(), this._dataProblemCanBeShown, this._dataProblemViewModel.visible());
				...
				_updateErrorWidgetIsShown() {
					...
					const l = null !== (t = null === (e = this._source.isSymbolInvalid()) || void 0 === e ? void 0 : e.value()) && void 0 !== t && t,
						a = null !== (i = null === (s = this._dataSourceHasErrorVisible) || void 0 === s ? void 0 : s.value()) && void 0 !== i && i;
					this.errorWidgetIsShown.setValue(l || a)
				}
				_handleToggleDropdown(e) {
					var t, s;
					this._menuPosition = e, this._menuOpened = !this._menuOpened, this._menuOpened && (null === (t = this._source.symbol()) || void 0 === t || t.subscribe(this._handleDropdownMenuClose), s = "Open full tooltip for statuses: " + this._tooltips.value().join(", "), (0, V.trackEvent)("GUI", "Statuses widget's action", s)), this._updateDropdownMenu()
				}
				_updateDropdownMenu() {
					Promise.all([s.e(7610), s.e(3894), s.e(9917), s.e(5514), s.e(306), s.e(4940), s.e(8643)]).then(s.bind(s, 36783)).then(e => {
						e.render(this._menuOpened, this._container, this._renderer.element, this._statusWidgetInfos, this._handleDropdownMenuClose, (0, i.ensureNotNull)(this._menuPosition))
					})
				}
			}
			s(51759);
			...
			class Ni {
				constructor(e, t) {
					this._symbol = null, this._symbolInfo = new (a())(null).spawn(), this._source = e, e.properties().hasChild("symbol") && (this._symbol = (0, j.createWVFromGetterAndSubscription)(() => e.properties().symbol.value(), e.properties().symbol.listeners()));
					const s = [];
					if ((0, pe.isStudy)(e) || (0,
						pe.isStudyStub)(e)) this._isSymbolInvalid = (0, Bi.createWVFromGetterAndSubscriptions)(() => e.isSymbolInvalid() && e.isActualInterval(), s), s.push(e.onStatusChanged(), e.onIsActualIntervalChange());
					else {
						(0, i.assert)(e === t.mainSeries());
						const l = t.mainSeries();
						this._isSymbolInvalid = (0, j.createWVFromGetterAndSubscription)(() => l.isSymbolInvalid(), l.onStatusChanged()), s.push(l.onStatusChanged()), this._symbolInfo = (0, j.createWVFromGetterAndSubscription)(l.symbolInfo.bind(l), l.dataEvents().symbolResolved())
					}
					this._dataSourceErrorStatus = (0, Bi.createWVFromGetterAndSubscriptions)(() => this._source.statusProvider({}).errorStatus(), s)
				}
				destroy() {
					var e, t;
			...
			const Ii = (0, k.t)("Replay mode"),
				zi = (0, k.t)("You're in Replay mode. You're in Replay mode. You're in Replay mode.");
			new Map([
				[!0, new Map([
					["small", Pi],
					["large", Pi]
			...
			class Oi extends Hi {
				constructor(e, t, s) {
					super(new Ni(e, t), s), this._isInReplay = new (a())(!1).readonly().spawn(), this._isInReplayCanBeShown = null, this._inited = !1
				}
				destroy() {
					super.destroy()
				}
			...
			const Ui = {
				...
				ji = (d.enabled("hide_legend_by_default"), d.enabled("fundamental_widget")),
			...
			class $i {
				constructor(e, t, s, i, l, n, r) {
					...
					this._isDataSourcesCollapsed = new (a())(d.value()), d.subscribe(this, () => {
					...
					const c = u.paneProperties.childs().legendProperties.childs().showBackground,
						_ = new (a())(c.value());
					c.subscribe(this, () => {
						_.setValue(c.value())
					});
					const p = u.paneProperties.childs().legendProperties.childs().backgroundTransparency,
						m = new (a())(p.value());
					p.subscribe(this, () => {
						m.setValue(p.value())
					}), this._hideNotMainSources = i.spawn(), this._hideNotMainSources.subscribe(this._updateLegendVisibilities.bind(this)), this._hideWholeLegend = l.spawn(), this._hideWholeLegend.subscribe(this._updateLegendVisibilities.bind(this)), this._isPaneMain = new (a())(this._getIsPaneMainValue()), this._updateCollapsedSourcesModeThrottle = (0, Ri.default)(this._updateCollapsedSourcesMode.bind(this), 100), this._renderer = new R({
				...
				destroy() {
					...
					this._customLegendWidgetsMap.clear(), this._renderer.destroy(), delete this._renderer,
						this._showLegendCalculatedProperty().unsubscribeAll(this), this._showLegendOriginalProperty().unsubscribeAll(this);
				...
				onShowLegendWidgetContextMenu(e, t) {
					...
					return function (e, t, s, i, l, a) {
						...
						})), t.showOpenMarketStatus && o.push(new He.Action({
						...
						})), o.push(new He.Separator), void 0 !== n) {
							const e = n.get(0);
							void 0 !== e && e.length > 0 && (o.push(...e), o.push(new He.Separator))
						}
						const d = i.get(1);
						...
						return t.settings && (o.push(new He.Separator), o.push(new He.Action({
							actionId: "Chart.Dialogs.ShowGeneralSettings.LegendTab",
							label: st,
							icon: Ie,
							statName: "Settings...",
							onExecute: () => s(ie.TabNames.legend)
						}))), Be.ContextMenuManager.showMenu(o, l, void 0, {
				...
				updateLayout() {
					const e = this._paneWidget.state().sourcesByGroup().priceSources().filter(e => null !== e.statusView());
					if (0 === e.length) return;
					...
					if (0 === o)
						for (let t = e.length - 1; t >= 0; t--) l.push(new Ae(this._model, e[t], this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu)), a.push(new Hi(new Ni(e[t], this._model.model()), this._options.statusesWidgets));
					else {
						let t = 0;
				...
				updateThemedColors(e) {
					null === e && (e = (0,
						Fi.getStdThemedValue)("chartProperties.paneProperties.background", this._backgroundThemeName.value())), this._themedColor.setValue(e || "")
				}
				firstTitle() {
				...
				addMargin(e) {
					...
					this._margin = e;
					this._renderer.getElement().style.maxWidth = 0 === this._margin ? "" : `calc(100% - ${this._margin + Gi}px)`, this._updateWidgetModeBySize()
				}
				...
				_destroyMainDataSource() {
					(0, i.ensureNotNull)(this._mainSeriesStatusWidget).destroy(), this._mainSeriesStatusWidget = null, (0, i.ensureNotNull)(this._mainSeriesViewModel).destroy(), this._mainSeriesViewModel = null
				}
					...
					if (this._availableHeight > 0 && e > 2) {
						...
						if (null !== s) {
							...
							if (e > a + 1) {
								...
								return this._collapsedDataSourcesTitle.setValue(t), void this._collapsedDataSourcesCount.setValue(e - a)
							}
						}
					}
				...
				_getCustomTextColorValue() {
					...
					return (0, Fi.isStdThemedDefaultValue)("chartProperties.scalesProperties.textColor", e, (0, Fi.getCurrentTheme)().name) ? null : e
				}
				_clearSubscriptions() {
				...
				_addCustomWidgetForLayerBlock(e) {
					...
					for (const l of Array.from(t.keys())) {
						...
						for (let t = a.length; t < o.length; t++) {
							...
							0 === e && 0 === l && s.setGlobalVisibility(this._hideNotMainSources.opposite()), a.push(s), this._renderer.addCustomWidget(s, {
								block: e,
								position: l
							}), i = !0
						}
		...
		17904: (e, t, s) => {
			...
			class _ {
				constructor(e, t, s) {
					this._parentEl = document.createElement("div"), this._listActionsWrapperEl = null, this._listActionsElements = {}, this._actionsSpawns = {}, this._onMouseEnterLeaveEventHandler = null, this._mouseOverWidget = !1, this._wrapEl = e,
					...
					this._render(), this._updatePaneControlsWidgetVisibility(), this._updateThemedColor(this._themedColor.value()), this._parentEl.classList.toggle(u.touchMode, d.trackingModeIsAvailable), this._parentEl.addEventListener("contextmenu", e => e.preventDefault())
				}
				destroy() {
				...
				updateWidgetModeByWidth(e) {
					...
					i.classList.toggle(c.blockHidden, t || s), l.classList.toggle(c.blockHidden, t || !s || !this._actions.more.visible.value())
				}
				_render() {
				...
				_renderActions() {
					...
					for (const e of Object.keys(this._listActionsElements)) (0, n.ensureNotNull)(this._listActionsElements[e]).classList.add(u.newButton);
					this._parentEl.append(this._listActionsElements.more)
				}
				_updateActionVisibilities(e, t) {
					(0, n.ensureNotNull)(this._listActionsElements[e]).classList.toggle(c.blockHidden, !t)
				}
				_updateActionTitle(e, t) {
					(0, n.ensureNotNull)(this._listActionsElements[e]).setAttribute("title", t)
				}
				...
				_updateThemedColor(e) {
					if (e.length > 0) {
						const [t, s, i] = (0, r.parseRgb)(e);
						this._parentEl.style.color = (0, r.rgbaToString)([t, s, i, (0, r.normalizeAlphaComponent)(.8)])
			...
			class F {
				...
				updateThemedColors(e) {
					null === e && (e = (0, f.getStdThemedValue)("chartProperties.paneProperties.background", this._backgroundThemeName.value())), this._themedColor.setValue(e || "")
				}
				...
				_getCloseButtonVisibility() {
					...
					let t = !1;
					return e.containsMainSeries() || e.isMaximized() || L || (t = e.dataSources().some(e => (0, o.isStudy)(e))), t
				}
				_onCloseButton() {
				...
				_showButtonsInContextMenu(e) {
					e.preventDefault(), this._moreCMShown || function (e, t, s) {
						...
						return m.ContextMenuManager.showMenu(i, {
							clientX: l.right,
		...
		59726: (e, t, s) => {
			...
			function i(e, t, s, i, l) {
				function a(l) {
					...
					const a = l.target;
					void 0 !== s && null !== t && null !== a && a.ownerDocument === i && (t.contains(a) || s(l))
				}
				return l.click && i.addEventListener("click", a, !1), l.mouseDown && i.addEventListener("mousedown", a, !1), l.touchEnd && i.addEventListener("touchend", a, !1), l.touchStart && i.addEventListener("touchstart", a, !1), () => {
					i.removeEventListener("click", a, !1), i.removeEventListener("mousedown", a, !1), i.removeEventListener("touchend", a, !1), i.removeEventListener("touchstart", a, !1)
				}
			}
			s.d(t, {
