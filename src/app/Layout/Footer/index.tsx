...
const Footer = () => {
    //
    return (
        <div className="bg-L-basic dark:bg-D-basic dark:text-L-basic text-D-basic border-L-gray-350 dark:border-D-gray-350 h-[40px] max-h-[40px] max-w-full w-full items-center  px-4  grid grid-cols-min-one border-t">
