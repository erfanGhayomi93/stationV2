            ...
            <div className={styles.tradedValues}>
                <div className={styles.inner}>
                    <Tippy
                        ...
                        arrow={false}
                        className={clsx('bg-gray-700 dark:bg-D-gray-700 top-4',
                            //  theme
                            )}
                    >
                        <div
                ...
                <div className={styles.sliderInner}>
                    <div className={clsx(styles.section, styles.sell)}>
                        ...
                        <Tippy
                            ...
                            className={clsx('bg-gray-700 dark:bg-D-gray-700 bg-current custom-arrow', 
                                // theme
                            )}
                        >
                            <div
                    ...
                    <div className={clsx(styles.section, styles.buy)}>
                        ...
                        <Tippy
                            ...
                            className={clsx('bg-gray-700 dark:bg-D-gray-700 custom-arrow', 
                                // theme
                            )}
                        >
                            <div
