        ...
        <div className="bg-L-gray-100 dark:bg-D-gray-100 rounded-md px-4 py-2 flex">
            <div className="w-full h-full grid grid-cols-16 gap-4">
                ...
                <FilterBlock label={t('FilterFieldLabel.Customer')} className="col-span-3">
                    <CustomerMegaSelect setSelected={(selected) => handleValueChange('CustomerISIN', selected)} selected={CustomerISIN as any} />
                </FilterBlock>
                ...
                <FilterBlock label={t('FilterFieldLabel.Market')} className="">
                    <Select
                        value={MarketUnitType}
                        onChange={(selected) => handleValueChange('MarketType', selected)}
                        options={marketUnitTypeOption}
                    />
                </FilterBlock>
                <FilterBlock label={t('FilterFieldLabel.MarketUnit')} className="col-span-3 max-w-[250px] min-w-[250px]">
                    <Select value={MarketType} onChange={(selected) => handleValueChange('MarketUnitType', selected)} options={marketUnitOption} />
                </FilterBlock>
