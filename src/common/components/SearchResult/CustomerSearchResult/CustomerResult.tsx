        ...
        <>
            {qData?.length
                ? qData.map((item, inx) => (
                      <Combo.DataSet
                          key={inx}
                          className="even:bg-L-gray-100 even:dark:bg-D-gray-100 border-b last:border-none bg-L-basic dark:bg-D-basic border-L-gray-300 dark:border-D-gray-300 py-2 flex items-center gap-2 hover:bg-sky-100 cursor-pointer px-2"
                          ...
                          <div className="flex justify-between w-full items-center px-2 text-1.2">
                              <div className="flex flex-col gap-2">
                                  <div className="flex gap-3 items-center w-[180px]  justify-between">
                                      <span className="truncate text-L-gray-500 dark:text-D-gray-500">{item.customerTitle}</span>
                                  </div>
                              ...
                              <span className="text-1.2 text-L-gray-450 dark:text-D-gray-450">{item.nationalCode || '-'}</span>
                          </div>
                      </Combo.DataSet>
                  ))
                : NotFoundResult}
