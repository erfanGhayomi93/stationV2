...
const PriceView = ({
     ...
     return (
          <div className="flex snap-center flex-nowrap justify-between gap-1 whitespace-nowrap p-2 text-xs text-content-paragraph">
               ...
               >
                    ...
                    {amountChange && <span className={textColorClassName}>{sepNumbers(amountChange)}</span>}
