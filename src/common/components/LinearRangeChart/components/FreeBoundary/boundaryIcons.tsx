...
const BoundaryIcons: React.FC<Props & HTMLAttributes<HTMLDivElement>> = ({
	...
	return (
		<div
			className="lc-absolute lc-top-0 lc-w-full lc-z-50"
			style={{ padding: "0 10px" }}
		>
			<div
				className="lc-relative  -lc-translate-y-1/2 lc-overflow-hidden"
				...
				>
					<div className={`lc-absolute -lc-translate-x-1/2 -lc-top-1  `}>
						<div
							...
							style={{
								color:
                  boundaryData[0] >= originData ? positiveColor : negativeColor,
							}}
						>
							{boundaryIcons?.end}
						</div>
