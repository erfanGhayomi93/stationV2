...
const Exchange: React.FC<Props & HTMLAttributes<HTMLDivElement>> = ({
    ...
    return (
        <div className=" lc-relative  lc-w-full  lc-overflow-hidden  lc-h-12 -lc-mb-12 -lc-top-4 " data-mn="exchange">
            <span
                style={{
            ...
            >
                <span className=" lc-absolute  lc-w-0  lc-h-6 lc-left-0" title={exchangeData[0].toString()}>
                    {React.cloneElement(exchangeIcons.start, {
                        className: exchangeIcons.start.props.className + '  lc-absolute lc-right-1/2 lc-translate-x-1/2 ',
                    })}
                </span>
            </span>
            ...
            >
                <span className=" lc-absolute  lc-w-0  lc-h-6 lc-left-0" title={exchangeData[1].toString()}>
                    {React.cloneElement(exchangeIcons.end, {
                        className: exchangeIcons.end.props.className + '  lc-absolute lc-right-1/2 lc-translate-x-1/2 ',
                    })}
                </span>
            </span>
        </div>
