import { TriangleIcon } from "src/components/common/LinearRangeChart/Icons";

export const exampleTraderOptions = {
	footer: false,
	ruler: true,
	rtl: true,
	badge: true,
	...
	exchangeIcons: {
		start: (
			<TriangleIcon className="lc-rotate-180 lc-text-gray-700 dark:lc-text-white dark:text-dark-primary-100" />
		),
		end: (
			<TriangleIcon className="lc-text-gray-700 dark:lc-text-white dark:text-dark-primary-100" />
		),
	},
};
