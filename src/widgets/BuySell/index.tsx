    ...
    return (
        <>
            <TabsList
                ...
                items={items}
                fill
                buttonClass="dark:text-D-gray-450 text-L-gray-450 border-t-2 dark:border-t-transparent border-b border-t-transparent bg-L-gray-150 dark:bg-D-gray-150  dark:border-D-gray-350 border-L-gray-350"
            />
        </>
    );
};
