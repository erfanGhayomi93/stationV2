...
const BuySell = () => {
        ...
        () => [
            {
                ...
                tabClass:
                    'bg-L-success-50 outline-none dark:bg-D-success-50 text-L-gray-500 dark:text-D-gray-700 rounded-md',
                selectedButtonClass:
            ...
            },
            {
                ...
                content: <GroupBuySell />,
                tabClass:
                    'bg-L-error-50  outline-none dark:bg-D-error-50 text-L-gray-500 dark:text-D-gray-700 rounded-md',
                selectedButtonClass:
    ...
    return (
        <TabsList
            ...
            className='w-full h-full flex flex-col relative text-1.2 rounded-md'
        />
    );
};
