    ...
    const items: ITabItemType[] = useMemo<ITabItemType[]>(
        () => [
            ...
            },
            {
                ...
                content: <GroupBuySell />,
                tabClass:
                    'bg-L-error-101  outline-none border   border-t-0   dark:border-D-gray-400 border-L-gray-400 dark:bg-D-error-50 text-L-gray-500 dark:text-D-gray-700',
                selectedButtonClass:
                    'text-L-error-200 outline-none   dark:text-L-error-200 bg-L-error-101 dark:bg-D-error-50 after:dark:bg-D-error-50 after:bg-L-error-101 font-semibold border-t-2  border-L-error-200 dark:border-D-error-200 border-r  dark:border-r-D-gray-400 border-r-L-gray-400',
            },
        ],
        [],
    );
