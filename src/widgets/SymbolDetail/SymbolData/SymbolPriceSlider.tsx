...
const SymbolPriceSlider = ({
	...
	const draw = () => {
		try {
			...
			instanceOfConfig.firstTradedPriceAsPercent = Number((((firstTradedPrice - yesterdayClosingPrice) / yesterdayClosingPrice) * 100).toFixed(2)) * 1;
			instanceOfConfig.lastTradedPriceAsPercent = Number((((lastTradedPrice - yesterdayClosingPrice) / yesterdayClosingPrice) * 100).toFixed(2)) * 1;
			...
			instanceOfConfig.lowestTradePriceOfTradingDayAsPercent = Number((((lowestTradePriceOfTradingDay - yesterdayClosingPrice) / yesterdayClosingPrice) * 100).toFixed(2)) * 1;
			instanceOfConfig.highestTradePriceOfTradingDayAsPercent = Number((((highestTradePriceOfTradingDay - yesterdayClosingPrice) / yesterdayClosingPrice) * 100).toFixed(2)) * 1;
		...
		<div ref={rootRef} className={clsx(styles.root, theme === 'dark' && styles.dark)}>
			...
			<div className={styles.tradedValues}>
				<div className={styles.inner}>
					<Tippy
						content={(
							<div dir='ltr' className='flex items-center gap-4'>
								<span className={clsx('transition duration-300 text-xs font-medium', config.firstTradedPriceAsPercent >= 0 ? 'text-L-success-150' : 'text-L-error-150')}>{sepNumbers(exchangeData[0])} ({config.firstTradedPriceAsPercent}%)</span>
					...
					>
						<div style={{ transform: `translateX(${config.firstTradedPrice}px)` }} className={clsx('transition duration-300', styles.value)}>
							<svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.97656 11.0645L2.19958 6.43259L6.97656 1.80073L11.7535 6.43259L6.97656 11.0645Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
								<path d="M11.7535 11.2959L6.97656 15.9278L2.19959 11.2959" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
							</svg>
						</div>
					</Tippy>
					...
					<Tippy
						content={(
							<div dir='ltr' className='flex items-center gap-4'>
								<span className={clsx('transition duration-300 text-xs font-medium', config.lastTradedPriceAsPercent >= 0 ? 'text-success-400' : 'text-error-300')}>{sepNumbers(exchangeData[1])}  ({config.lastTradedPriceAsPercent}%)</span>
						...
						className={clsx('text-gray-400 dark:text-dark-gray-500 top-4 bg-gray-400 dark:bg-dark-gray-400', theme)}
					>
						<div style={{ transform: `translateX(${config.lastTradedPrice}px)` }} className={clsx('transition duration-300', styles.value)}>
							<svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.97656 11.0645L2.19958 6.43259L6.97656 1.80073L11.7535 6.43259L6.97656 11.0645Z" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
								<path d="M11.7535 11.2959L6.97656 15.9278L2.19959 11.2959" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
							</svg>
						</div>
					</Tippy>
				...
				<div className={styles.sliderInner}>
					<div className={clsx(styles.section, styles.sell)}>
						...
						<Tippy
							content={(
								<div dir='ltr' className='flex items-center gap-4'>
									<span className={clsx('font-medium text-xs', config.lowestTradePriceOfTradingDayAsPercent >= 0 ? 'text-success-400' : 'text-error-300')}>{sepNumbers(boundaryData[0])} ({config.lowestTradePriceOfTradingDayAsPercent}%)</span>
									<span className='text-black dark:text-white text-xs font-normal'>:{t('price_range_slider.lowest_trade_price')}</span>
								</div>
							)}
					...
					<div className={clsx(styles.section, styles.buy)}>
						...
						<Tippy
							content={(
								<div dir='ltr' className='flex items-center gap-4'>
									<span className={clsx('font-medium text-xs', config.highestTradePriceOfTradingDayAsPercent >= 0 ? 'text-success-400' : 'text-error-300')}>{sepNumbers(boundaryData[1])} ({config.highestTradePriceOfTradingDayAsPercent}%)</span>
									<span className='text-black dark:text-white text-xs font-normal'>:{t('price_range_slider.highest_trade_price')}</span>
								</div>
							)}
			...
			<div className={styles.container}>
				...
				<div style={{ left: '16.667%' }} className={clsx(styles.div, isBetween(boundaryData[0], averageNumbers[1], boundaryData[1]) && styles.active)}>
					<div className={styles.inner}>
						<span className={clsx(styles.rhombus)} />
						<span className={clsx(styles.line)} />
				...
				<div style={{ left: '33.334%' }} className={clsx(styles.div, isBetween(boundaryData[0], averageNumbers[2], boundaryData[1]) && styles.active)}>
					<div className={styles.inner}>
						<span className={clsx(styles.rhombus)} />
						<span className={clsx(styles.line)} />
				...
				<div style={{ left: '66.667%' }} className={clsx(styles.div, isBetween(boundaryData[0], averageNumbers[4], boundaryData[1]) && styles.active)}>
					<div className={styles.inner}>
						<span className={clsx(styles.rhombus)} />
						<span className={clsx(styles.line)} />
				...
				<div style={{ left: '83.334%' }} className={clsx(styles.div, isBetween(boundaryData[0], averageNumbers[5], boundaryData[1]) && styles.active)}>
					<div className={styles.inner}>
						<span className={clsx(styles.rhombus)} />
						<span className={clsx(styles.line)} />
